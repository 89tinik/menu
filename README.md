...
<h4>Для подтверждения почты - отправляется код на указаный email, если на локале не настроена отправка писем нужно
раскомментить в views/login/verification.php 16-ую строку - код будет виден над полем ввода</h4>
<p align="center">
